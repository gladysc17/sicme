...
public class FacadeCita {
    ...
    public int cantidadCitasProSer(String servicio, String fechaI, String fechaF, int pro) throws SQLException {
        return new NegocioCita().cantidadCitasProSer(servicio, fechaI, fechaF, pro);
    }
}
