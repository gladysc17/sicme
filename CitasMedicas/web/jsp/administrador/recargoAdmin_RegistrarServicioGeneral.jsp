<%-- 
    Document   : recargoAdmin_RegistrarServicioGeneral
    Created on : 23-mar-2017, 20:30:50
    Author     : Gladys M
--%>
        ...
        <div class="col-md-8 form-group">            
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2 align="center">  REGISTRAR USUARIO SERVICIO GENERAL</h2>
                </div>
                <div class="panel-body">  
                    <form action="../controlador/procesarRegistroServiciosGenerales.jsp" method="post">
