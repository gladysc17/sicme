...
<html>
    ...
    <body>
        <%
            ...
            String frecardiaca_hcmed = request.getParameter("frecCardiaca");
            String frerespiratoria_hcmed = request.getParameter("frecResp");
            String tensionarterial_hcmed = request.getParameter("tension");
            String temperatura_hcmed = request.getParameter("temperatura");
            String peso_hcmed = request.getParameter("peso");
            String talla_hcmed = request.getParameter("talla");
