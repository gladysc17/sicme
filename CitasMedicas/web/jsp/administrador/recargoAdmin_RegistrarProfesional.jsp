<%-- 
    Document   : recargoAdmin_RegistrarProfesional
    Created on : 23-mar-2017, 18:59:59
    Author     : Gladys M
--%>
        ...
        <div class="col-md-8 form-group">            
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2 align="center">  REGISTRO PROFESIONAL </h2>
                </div>
                <div class="panel-body">  
                    <form action="../controlador/procesarRegistroProfesional.jsp" method="post">
