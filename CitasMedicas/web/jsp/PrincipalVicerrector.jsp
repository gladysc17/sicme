                        ...
                        <div class="dropdown profile-element"> <span>
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><%=nombre%></strong>
                                    </span> <span class="text-muted text-xs block">Vicerrector <b class="caret"></b></span> </span> </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><input style="font-size: 20px;" type="button" class="btn btn-sm btn-link" value="Perfil" onclick="cargarForm('vicerrector/recargoVice_DatosPersonales.jsp')"/></li>                                    
                                <li class="divider"></li>
                                <li><a href="../controlador/procesarCierreSesion.jsp"><h3>Cerrar Sesion</h3></a></li>
                                <li><a href="../index.jsp"><h3>Principal</h3></a></li>
                            </ul>
                        </div>                           
                    </li>
                </ul>
            ...
            <div id="page-wrapper" class="gray-bg">
                <div class="row wrapper border-bottom white-bg page-heading" id="rows">
                    <div class="col-lg-10">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <a href="PrincipalVicerrector.jsp"><strong><i class="fa fa-home"></i>- Principal</strong></a>
                            </li>
