<%-- 
    Document   : recargoAdmin_RegistrarOtroUsuario
    Created on : 23-mar-2017, 20:04:31
    Author     : Gladys M
--%>
        ...
        <div class="col-md-8 form-group">            
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2 align="center">  REGISTRO OTRO USUARIO </h2>
                </div>
                <div class="panel-body">  
                    <form action="../controlador/procesarRegistroOtrosUsuarios.jsp" method="post">
                        ...
                        <div class="form-group">                              
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="email" class="form-control" id="rol" name="rol" required="">
                            </div>
                        </div>
