<%-- 
    Document   : recargoAdmin_RegistrarMedico
    Created on : 23-mar-2017, 19:31:49
    Author     : Gladys M
--%>
        ...
        <div class="col-md-8 form-group">            
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2 align="center">  REGISTRO MÉDICO</h2>
                </div>
                <div class="panel-body">  
                    <form action="../controlador/procesarRegistroMedico.jsp" method="post">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-control">
                                    <select name="servicio" id="servicio">
                                        ...
                                        <option value="psicologia">Psicologìa</option>
