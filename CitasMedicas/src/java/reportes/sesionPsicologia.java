 ...
 * @author Gladys M
 */
@WebServlet(name = "sesionPsicologia", urlPatterns = {"/sesionPsicologia"})
public class sesionPsicologia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                m.put("idsesion", idsesion);        
                System.out.println("idsesion"+idsesion);

                JasperReport reporte = (JasperReport) JRLoader.loadObject(this.getClass().getResourceAsStream("sesionpsicologia.jasper"));
    ...
    protected void generarDescargaPDF(String ruta, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            String originalFileName = "sesionpsi.pdf";
